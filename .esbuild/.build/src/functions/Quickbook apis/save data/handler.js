...
// src/functions/Quickbook apis/save data/handler.ts
__export(exports, {
  main: () => main
});
...
var save_data = async (event) => {
  try {
    ...
    await DynamoDB2.saveData(args);
    return formatJSONResponse(__spreadValues({}, body));
  } catch (err) {
