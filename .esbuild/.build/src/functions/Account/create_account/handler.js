...
// src/functions/Account/create_account/handler.ts
__export(exports, {
  main: () => main
});
...
var create_account = async (event) => {
  try {
    ...
    const response = await import_axios.default.post(`https://sandbox-quickbooks.api.intuit.com/v3/company/${realmId}/account?minorversion=63`, body, {
      headers: {
...
var main = middyfy(create_account);
