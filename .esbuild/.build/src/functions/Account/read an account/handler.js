...
// src/functions/Account/read an account/handler.ts
__export(exports, {
  main: () => main
});
...
var query_account = async (event) => {
  try {
    ...
    const response = await axios.get(`https://sandbox-quickbooks.api.intuit.com/v3/company/${realm_id}/account/${id}?minorversion =63`, {
      headers: {
